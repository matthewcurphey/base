...
def extract_castle_sales():
    ...
    # File paths
    file_2024 = os.path.join(CASTLE_RAW_DIR, "SALES_2024.csv")
    file_2025 = os.path.join(CASTLE_RAW_DIR, "SALES_2025.csv")
    file_ytd  = os.path.join(CASTLE_RAW_DIR, "SALES.csv")
