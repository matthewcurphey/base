...
staged as (
    ...
    select
        ...
        list_price_per_lbs_gross::numeric       as list_price_per_lbs_gross,
        price_per_lbs_gross::numeric            as price_per_lbs_gross,
        ...
        tgp_pct::numeric                         as tgp_pct,
        mgp_pct::numeric                         as mgp_pct,
        absorption_cost_usd::numeric(18,4)      as absorption_cost_usd,

        cut_uom:: text                         as cut_uom,
        cut_shape::text                      as cut_shape,
        cut_width::numeric(18,6)                     as cut_width,
        cut_length::numeric(18,6)                          as cut_length,
