...
BRANCHES = {
    ...
    "ATL": {"to": "whendry@amcastle.com; ; DLege@amcastle.com",                           "cc": CC_US_CAN,  "greeting": "Hi William/Danielle,",    "active": True},
    "CHA": {"to": "lwilliams2@amcastle.com; llatham@amcastle.com",                        "cc": CC_US_CAN,  "greeting": "Hi Luke/Lauren,",         "active": False},
    "CLE": {"to": "trobinson@amcastle.com",                                               "cc": CC_US_CAN,  "greeting": "Hi Tim,",                 "active": True},
    ...
    "HAI": {"to": "jariola@amcastle.com; KKALINSKI@amcastle.com; PIgnas@amcastle.com",    "cc": CC_US_CAN,  "greeting": "Hi Patrick/Joe/Kara,",    "active": True},
    "JVL": {"to": "rojones@amcastle.com; jariola@amcastle.com; KKALINSKI@amcastle.com",   "cc": CC_US_CAN,  "greeting": "Hi Rob/Joe/Karam,",       "active": True},
    "LOS": {"to": "shage@amcastle.com",                                                   "cc": CC_US_CAN,  "greeting": "Hi Salim,",               "active": True},
    "MCH": {"to": "agarcia@amcastle.com; asantiago@amcastle.com",                         "cc": CC_INTL_MX, "greeting": "Hi,",                     "active": True},
    "MTY": {"to": "agarcia@amcastle.com; mcorona@amcastle.com",                           "cc": CC_INTL_MX, "greeting": "Hi,",                     "active": True},
    "MXM": {"to": "agarcia@amcastle.com; magonzalez@amcastle.com",                        "cc": CC_INTL_MX, "greeting": "Hi,",                     "active": True},
    "MXQ": {"to": "agarcia@amcastle.com; rcruz@amcastle.com",                             "cc": CC_INTL_MX, "greeting": "Hi,",                     "active": True},
    ...
    "STO": {"to": "gcosio@amcastle.com; shage@amcastle.com",                              "cc": CC_US_CAN,  "greeting": "Hi Salim,",               "active": True},
    "TOR": {"to": "dmbrown@amcastle.com; gdedieu@amcastle.com",                           "cc": CC_US_CAN,  "greeting": "Hi Doug,",                "active": True},
    "WIE": {"to": "hgarcia@amcastle.com; DLege@amcastle.com",                             "cc": CC_US_CAN,  "greeting": "Hi Henry/Danielle,",      "active": True},
